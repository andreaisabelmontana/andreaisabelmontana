...
> One interactive companion hub per course, across the full four-year BCSAI degree. **Each course title links to its hub**; the projects column lists everything built behind it.
