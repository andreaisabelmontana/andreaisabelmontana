...
const DESC = {
  ...
  'orrery-lab': 'N-body what-if solar system · study rebuild',
  'event-horizon': '3D black-hole accretion sim · study rebuild',
  'gyrocube': 'Tilt-a-cube 3D ball-maze puzzle · study rebuild',
  'ripple': '2D SPH fluid you can stir · study rebuild',
  'antfarm': 'Emergent ant-colony foraging · study rebuild',
  'murmuration': 'Boids flocking simulation · study rebuild',
  'strange-attractors': '3D chaotic-attractor explorer · study rebuild',
  'fractal-voyager': 'GPU Mandelbrot & Julia explorer · study rebuild',
  'bank-marketing-ml': 'Term-deposit subscription classifier · study rebuild',
  'nestmatch': 'Plain-language rental search · study rebuild',
  'rebound': 'Modern Pong with spin physics · study rebuild',
  'coil': 'Refined Snake · study rebuild',
  'sonar': 'Echolocation maze game · study rebuild',
  'knightmare': 'Dodge escalating chess-piece hazards · study rebuild',
  'knightmare-server': 'WebSocket leaderboard & matchmaking · study rebuild',
};
...
const EXTRA = {
  ...
  physics: [PAGES('pyfreebody'), PAGES('radioform-web'), PAGES('orrery-lab'), PAGES('event-horizon'), PAGES('gyrocube')],
  modeling: [PAGES('ripple'), PAGES('antfarm'), PAGES('murmuration'), PAGES('strange-attractors')],
  calc:    [PAGES('fractal-voyager')],
  ...
  cp2:     [PAGES('futclub-manager'), PAGES('rebound'), PAGES('coil'), PAGES('sonar'), PAGES('knightmare')],
  iec:     ['🎤 [pitch deck](https://canva.link/hah28m2jrnhfj42) — IE Challenge startup pitch'],
  sddo:    [PAGES('qrate'), PAGES('rerun'), PAGES('bug-tracker'), PAGES('daybook'), PAGES('dotfiles'), PAGES('sublime-config'), PAGES('dev-vm-setup'), SRC('knightmare-server')],
  ...
  nlp:     [PAGES('truthlens'), PAGES('stash'), PAGES('nestmatch')],
