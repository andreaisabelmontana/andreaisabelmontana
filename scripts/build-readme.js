...
const EXTRA = {
  ...
  hpc:     [PAGES('gpu-montecarlo-risk-rebuild'), PAGES('uncorrelated-returns'), PAGES('dalio-uncorrelated-returns-rebuild'), PAGES('time-series-momentum-rebuild'), PAGES('aimes-emanager'), PAGES('hpc-course'), PAGES('hpc_foundations_book'), PAGES('hpc_applications_book')],
