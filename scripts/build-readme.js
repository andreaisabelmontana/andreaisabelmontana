...
const EXTRA = {
  ...
  arch:    [PAGES('hostpad-802.11r')],
  cloud:   [PAGES('petcare')],
  mlf:     [PAGES('efficient-classifier-rebuild')],
  db:      [PAGES('fantasy-forum'), PAGES('matchup'), SRC('tablepro-rebuild')],
  entrep:  [PAGES('foodloop-rebuild')],
  cp2:     [PAGES('futclub-manager')],
  sddo:    [PAGES('qrate'), PAGES('rerun'), PAGES('bug-tracker'), PAGES('daybook'), PAGES('dotfiles'), PAGES('sublime-config'), PAGES('dev-vm-setup'), PAGES('milan-academic-pages')],
  reason:  [PAGES('symphony')],
  hpc:     [PAGES('gpu-montecarlo-risk-rebuild'), PAGES('uncorrelated-returns'), PAGES('dalio-uncorrelated-returns-rebuild'), PAGES('aimes-emanager'), PAGES('hpc-course'), PAGES('hpc_foundations_book'), PAGES('hpc_applications_book')],
  chat:    [PAGES('mistral-kit'), PAGES('radical-bot'), PAGES('bookdb-discovery'), PAGES('moviewatchlist'), PAGES('memora-rebuild')],
  vision:  [PAGES('fatigued-driver-detector'), PAGES('ie-tower-vpr'), PAGES('crittercut')],
